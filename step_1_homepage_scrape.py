...
class HomepageScraper:
    def __init__(self, excel_path, cache_file="scrape_link_cache.json", new_links_file="scrape_new_links.json", archive_dir="archives"):
        """初始化抓取器"""
...
def main(interval_minutes=None):
    ...
    scraper = HomepageScraper(excel_path)
